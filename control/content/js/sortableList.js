if (typeof buildfire == "undefined")
  throw "please add buildfire.js first to use sortableList components";
if (typeof buildfire.components == "undefined") buildfire.components = {};

if (typeof Sortable == "undefined")
  throw "please add sortable.min.js first to use sortableList components";
...
buildfire.components.SortableList = class SortableList {
  ...
  init(element) {
    if (typeof element == "string") this.element = document.getElement(element);
  ...
  injectItemElements(item, index, divRow) {
    ...
    if (item.icon) {
      ...
      img.src = buildfire.imageLib.cropImage(item.icon, {
        width: 16,
        height: 16,
      });
